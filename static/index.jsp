<!DOCTYPE html>
<!--[if lt IE 7]> <html lang="cn" ng-app="tasksystem" class="no-js lt-ie9 lt-ie8 lt-ie7"> <![endif]-->
<!--[if IE 7]> <html lang="cn" ng-app="tasksystem" class="no-js lt-ie9 lt-ie8"> <![endif]-->
<!--[if IE 8]> <html lang="cn" ng-app="tasksystem" class="no-js lt-ie9"> <![endif]-->
<!--[if gt IE 8]> --> <html lang="cn" ng-app="tasksystem" class="no-js">  <!--<![endif]-->
<head>
    <meta charset="utf-8"/>
    ...
    <link href="lib/uigrid/ui-grid-unstable.min.css" rel="stylesheet"/>
...
<script type='text/javascript' src='lib/uigrid/ui-grid-unstable.min.js'></script>
...
<script type='text/javascript' src='app/taskmanager/taskmanager.js'></script>
</body>
</html>
